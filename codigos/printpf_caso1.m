...
%                                                                         %        
%                         Funcao: 'printpf_caso1'                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


function printpf_caso1(baseMVA, bus, gen, branch, f, success, et, fd, mpopt)
...
%
%   $Id: printpf.m 2644 2015-03-11 19:34:22Z ray $
%
...
if OUT_ANY
    ...
    if isOPF && (success || OUT_FORCE)
        fprintf(fd, '\nCusto otimo total da geracao de potencia ativa = %.2f $/hr\n', f);
    end
end
...
%                 restricoes(cont,:) = [branch(i,F_BUS) branch(i,T_BUS)];
%                 cont = cont + 1;
%             end
%         end
%         fprintf(fd, '\n');
